...
class UltraAdmin extends UltraAdmin_Controller {
	...
	public function index() {
		// add page title
		$this->output->append_title('Clients');
		// add breadcrumbs
	...
	public function remove($encoded_id)
	{
		...
		if(!empty($id))
		{
			...
			$row = $this->client_model->deleteClient($id);
